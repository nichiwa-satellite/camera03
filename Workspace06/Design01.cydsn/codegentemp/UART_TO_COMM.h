...
#define UART_TO_COMM_RX_INTERRUPT_ENABLED           (1u)
#define UART_TO_COMM_TX_INTERRUPT_ENABLED           (1u)
...
#define UART_TO_COMM_TX_BUFFER_SIZE                 (36u)
#define UART_TO_COMM_RX_BUFFER_SIZE                 (36u)
...
#define UART_TO_COMM_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((0 << UART_TO_COMM_TX_STS_COMPLETE_SHIFT) \
                                        | (1 << UART_TO_COMM_TX_STS_FIFO_EMPTY_SHIFT) \
